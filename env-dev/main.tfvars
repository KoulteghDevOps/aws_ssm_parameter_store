parameters = [
  { name = "dev.frontend.catalogue_url", value = "http://catalogue-dev.gilbraltar.co.uk:80/" },
  { name = "dev.frontend.cart_url", value = "http://cart-dev.gilbraltar.co.uk:80/" },
  { name = "dev.frontend.user_url", value = "http://user-dev.gilbraltar.co.uk:80/" },
  { name = "dev.frontend.payment_url", value = "http://payment-dev.gilbraltar.co.uk:80/" },
  { name = "dev.frontend.shipping_url", value = "http://shipping-dev.gilbraltar.co.uk:80/" },
  ...
  { name = "dev.user.redis.host", value = "elasticache-dev-elasticache.gdyr43.ng.0001.use1.cache.amazonaws.com" },
  ...
  { name = "dev.cart.redis_host", value = "elasticache-dev-elasticache.gdyr43.ng.0001.use1.cache.amazonaws.com" },
  ...
  { name = "dev.rds.db_host", value = "rds-dev-rds.cluster-cn4v445mkiqq.us-east-1.rds.amazonaws.com" },
